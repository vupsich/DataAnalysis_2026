...
getwd()
#----------------read dataset--------------------------
example_df<-read.csv("C:\\Users\\admin\\Documents\\Data_Analysis_2026\\Data\\distribution.csv", header = TRUE,dec = ',', sep = ";")
